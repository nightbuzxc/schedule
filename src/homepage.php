...
<div class="logo-text">
    ...
    <a href="rozklad.php"><button class="button-1">Адміністрування</button></a>
</div>
</div>
        ...
        <details class="group-category">
            ...
            <div class="group-block">
                <?php foreach ($items as $subgroup): ?>
                    <a href="homepage.php?group_id=<?= $subgroup['id'] ?>" class="group-button-link">
            ...
            <div class='lesson-block'>
                ...
                <div class='edit_delete'>
                    <form action='edit.php' method='get' style='display:inline'>
                        ...
                        <button type='submit' class='small-btn'>Редагувати</button>
                    </form> | 
                    <form action='delete.php' method='get' style='display:inline' onsubmit='return confirm(\"Ви впевнені?\")'>
                        <input type='hidden' name='id' value='" . $row['id'] . "'>
                        <button type='submit' class='small-btn delete-btn'>Видалити</button>
                    </form>
                </div>
                <hr>
            </div>
...
<?php endif; ?>
    <a href="export-today.php"><button class="button-0">Експортувати змін в розкладі на сьогодні</button></a>
    <a href="userpage.php"><button class="button-0">Вийти з адмін-панелі</button></a>
